...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--npf', type=int, default=64,
                                 help='# of pred filters in first conv layer')
        ...
        self.parser.add_argument('--which_model_netP', type=str,
                                 default='unet_256',
                                 help='selects model to use for netG')
        ...
        self.parser.add_argument('--resize_or_crop', type=str,
